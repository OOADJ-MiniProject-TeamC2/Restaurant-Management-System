...
public class Database
{
    ...
    public final static String REPORT_FILE = "dataFiles/reports/report_";
    ...
    public String generateOrderReport( String todaysDate) throws DatabaseException
    {
        ...
        try{
            ...
            while (it.hasNext())
            {
                ...
                String output = String.format("Order ID:%4d  StaffName:%-30s  Total:Rs.%-5.2f %s\r\n",
            ...
            writer.write("Total sales:Rs." + totalAllOrder + "(" + orderCnt + ")" +
                    "  Canceled:Rs." + cancelTotal + "(" + cancelCnt + ")\r\n");
            writer.flush();
            writer.close();
        }
        catch(IOException e)
